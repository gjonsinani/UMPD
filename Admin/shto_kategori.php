...
<div class="table-wrapper">
    <form method="post" action="add_kategori.php" enctype='multipart/form-data' class="form control offset-md-4">
        <div class="col-md-6">
        ...
        <div class="col-12">
            <button name="add_kategori" type="submit" class="btn btn-primary" style="width: 8rem;">Shto</button>
        </div>
    </form>
</div>
<br><br>
