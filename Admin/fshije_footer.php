...
$result = mysqli_query(
    $conn,
    " CALL selectFooter('$fid')"
);
?>
<div class="container">
    <div class="d-form">
        <h3>Forma per menaxhimin e Footer-it</h3>
        <br><br>

        <form action="" method="post" class=" footer-bottom ">
            <div style="width: 70%; text-align: center; margin:0 15% 2% 15%;">
                <div class="input-group">
                    <input type="text" name="term" class="form-control" placeholder="Pëshkrimi ose ikona">
        ...
        <table class="table table-success table-striped">
            ...
            if (!empty($_REQUEST['term'])) {
                ...
                while ($row = mysqli_fetch_array($sql)) {
                    ...
                    echo "<td><a href=\"delete_footer.php?fid=$row[fid]\" class='btn btn-danger' type='submit'>
										Fshijë</a></td></tr>";
                }
            }
